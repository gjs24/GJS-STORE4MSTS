    ...
    <LegalPage
      ...
      sections={[
        ...
        },
        {
          ...
          body:
            "Refund requests must include order details, payment reference where available, product name, and a description of the issue. Approved refunds will be processed through the original payment method or Razorpay-supported refund process, subject to payment gateway and bank timelines."
        }
      ]}
    />
  );
