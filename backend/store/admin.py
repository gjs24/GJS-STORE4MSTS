...
class AssetAdmin(admin.ModelAdmin):
    list_display = ("title", "category", "simulator_type", "price", "is_free", "is_published", "is_featured", "download_count")
    list_filter = ("category", "simulator_type", "is_free", "is_published", "is_featured")
